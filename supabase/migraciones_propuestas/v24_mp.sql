-- ============================================
-- v24 (APLICADA el 23/09/2026 como v24_mp_monto_stock_revision; probada con
-- ROLLBACK: descuenta, es idempotente, no deja negativos, anon sin permiso): Mercado Pago blindado — monto esperado,
